                    ...
                    <div class="carousel-caption top-30 text-left">
                        <div class="row">
                            <div class="col-md-7 col-sm-7" id="hero-desktop">
                                ...
                                <br />
                                <h3 class="description animation animated-item-2">
                                    2024. 11. 01. - Debrecen, Lovarda
                                </h3>
                                <br />
                                <a href="https://oneticket.hu/events/3-gewiss-gala?locale=hu"
                                    style="color: white; background-color: #c0974a; border-color: #c0974a; border-radius: 5px; padding: 10px; font-size: 20px;"
            ...
            <div class="owl-carousel navigation-1 light-switch white" data-pagination="false" data-items="4"
                ...
                @foreach ($fighters as $fighter)
                    <div class="col-sm-4 col-md-3 icons-hover-color bottom-xs-pad-20">
                        <div class="image">
                            <!-- Image -->
                            <img src="{{asset('/storage/' . $fighter->photo)}}"
                                test="{{asset('storage/' . $fighter->photo)}}" alt="" title="" width="270" height="270" />
                        </div>
